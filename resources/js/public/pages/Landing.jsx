    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white dark:from-gray-900 dark:to-gray-950">
                {/* Navigation - No customer login/register */}
                <nav className="mx-auto flex max-w-6xl items-center justify-between p-6">
                    ...
                    <div className="flex gap-6 items-center">
                        <Link href="/" className="text-gray-700 hover:text-orange-600 dark:text-gray-300">
                            Home
                        </Link>
                        <Link href="/menu" className="text-gray-700 hover:text-orange-600 dark:text-gray-300">
                            Menu
                        </Link>
                        <Link href="/about" className="text-gray-700 hover:text-orange-600 dark:text-gray-300">
                            About
                        </Link>
                        <Link href="/contact" className="text-gray-700 hover:text-orange-600 dark:text-gray-300">
                            Contact
                        </Link>
                        <Link
                            href="/admin/login"
                            className="rounded-lg border-2 border-orange-500 px-5 py-2 text-orange-600 hover:bg-orange-50 dark:text-orange-400"
                        >
                            Admin Login
                        </Link>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-12 lg:flex-row">
                        ...
                        <div className="flex-1 text-center lg:text-left">
                            ...
                            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center lg:justify-start">
                                <Link
                                    href="/menu"
                                    className="rounded-lg bg-orange-500 px-8 py-3 font-semibold text-white hover:bg-orange-600 transition-all"
                                >
                                    View Full Menu
                                </Link>

                                {/* QR Code / Download App Section */}
                                <div className="flex items-center gap-3 rounded-lg border-2 border-gray-200 bg-white px-5 py-2 dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div className="grid gap-8 md:grid-cols-4">
                            ...
                            <div>
                                ...
                                <div className="mt-2 flex gap-2">
                                    <div className="rounded bg-gray-200 px-2 py-1 text-xs">QR Code</div>
                                </div>
                            </div>
                        </div>
